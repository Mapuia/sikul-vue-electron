<template>
        ...
        <div class="columns is-vcentered">
          ...
          <div class="column">
            <div class="field">
              ...
              <div class="select is-fullwidth">
                <select v-model="selectedSectionId" :disabled="!selectedClassId || sections.length === 0 || isLoading">
  ...
  <div v-if="!isPublished" class="form-container wide pb-1" >
