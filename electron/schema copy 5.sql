...
INSERT INTO Classes (ClassId, ClassName) VALUES
    ('KG1', 'KG-I'), ('KG2', 'KG-II'), ('1', 'I'), ('2', 'II'), ('3', 'III'), ('4', 'IV'), 
...
INSERT INTO Exams (ExamName, ExamType, Description) VALUES
    ('First Periodic Test', 'Periodic1', 'First periodic assessment of the term'),
    ('Half Yearly Exam', 'Term', 'Mid-term comprehensive examination'),
    ('Second Periodic Test', 'Periodic2', 'Second periodic assessment of the term'),
...
-- Students for Classes V, VI, VII - Sections A, B, C
...
INSERT INTO Students (Name, Gender, FathersName, MothersName, DOB, Aadhaar, APAR, PEN, Contact, Address, Status, Caste, Religion, Height, Weight, BloodGroup)
VALUES  
('Faizan Khan', 'Male', 'Naseem Khan', 'Shabana Khan', '2010-01-17', '111122225555', '111122225555', '10100000003', '9998887773', '16 Zakir Nagar, Delhi', 'Admitted', 'Minority', 'Muslim', 143, 41.2, 'B+');
...
VALUES (
    ...
    (SELECT Id FROM AcademicYears WHERE IsActive = 1),
    (SELECT Id FROM Classes WHERE ClassName = 'V'),
    (SELECT Id FROM Sections WHERE SectionName = 'C'),
    1,
    'New'
);
...
INSERT INTO Students (Name, Gender, FathersName, MothersName, DOB, Aadhaar, APAR, PEN, Contact, Address, Status, Caste, Religion, Height, Weight, BloodGroup)
VALUES 
('Nikita Das', 'Female', 'Rajiv Das', 'Sushmita Das', '2009-09-12', '222233334444', '222233334444', '10100000004', '9998887774', '27 Park Street, Delhi', 'Admitted', 'SC', 'Hindu', 150, 43.5, 'AB+');

INSERT INTO Admissions (StudentId, AcademicYearId, ClassId, SectionId, RollNo, AdmissionType)
VALUES (
    (SELECT Id FROM Students WHERE PEN = '10100000004'),
    (SELECT Id FROM AcademicYears WHERE IsActive = 1),
    (SELECT Id FROM Classes WHERE ClassName = 'VI'),
    (SELECT Id FROM Sections WHERE SectionName = 'A'),
    1,
    'New'
);
...
INSERT INTO Students (Name, Gender, FathersName, MothersName, DOB, Aadhaar, APAR, PEN, Contact, Address, Status, Caste, Religion, Height, Weight, BloodGroup)
VALUES 
('Aman Gupta', 'Male', 'Vinod Gupta', 'Seema Gupta', '2009-05-09', '222233335555', '222233335555', '10100000005', '9998887775', '88 Connaught Place, Delhi', 'Admitted', 'General', 'Hindu', 151, 45.0, 'A-');
...
INSERT INTO Students (Name, Gender, FathersName, MothersName, DOB, Aadhaar, APAR, PEN, Contact, Address, Status, Caste, Religion, Height, Weight, BloodGroup)
VALUES 
('Zoya Ansari', 'Female', 'Rafiq Ansari', 'Nasreen Ansari', '2009-07-11', '222233336666', '222233336666', '10100000006', '9998887776', '34 Azad Nagar, Delhi', 'Admitted', 'Minority', 'Muslim', 152, 44.0, 'O+');
...
INSERT INTO Students (Name, Gender, FathersName, MothersName, DOB, Aadhaar, APAR, PEN, Contact, Address, Status, Caste, Religion, Height, Weight, BloodGroup)
VALUES 
('Rohan Sen', 'Male', 'Suresh Sen', 'Meena Sen', '2008-11-02', '333344445555', '333344445555', '10100000007', '9998887777', '42 Nehru Enclave, Delhi', 'Admitted', 'ST', 'Hindu', 157, 48.5, 'B+');

INSERT INTO Admissions (StudentId, AcademicYearId, ClassId, SectionId, RollNo, AdmissionType)
VALUES (
    (SELECT Id FROM Students WHERE PEN = '10100000007'),
    (SELECT Id FROM AcademicYears WHERE IsActive = 1),
    (SELECT Id FROM Classes WHERE ClassName = 'VII'),
    (SELECT Id FROM Sections WHERE SectionName = 'A'),
    1,
    'New'
);
...
INSERT INTO Students (Name, Gender, FathersName, MothersName, DOB, Aadhaar, APAR, PEN, Contact, Address, Status, Caste, Religion, Height, Weight, BloodGroup)
VALUES  
('Mehak Sharma', 'Female', 'Kamal Sharma', 'Anita Sharma', '2008-08-19', '333344446666', '333344446666', '10100000008', '9998887778', '91 Ashok Vihar, Delhi', 'Admitted', 'General', 'Hindu', 155, 46.2, 'A+');
...
INSERT INTO Students (Name, Gender, FathersName, MothersName, DOB, Aadhaar, APAR, PEN, Contact, Address, Status, Caste, Religion, Height, Weight, BloodGroup)
VALUES 
('Rehan Ali', 'Male', 'Sajid Ali', 'Rukhsar Ali', '2008-02-14', '333344447777', '333344447777', '10100000009', '9998887779', '60 Okhla Phase 2, Delhi', 'Admitted', 'Minority', 'Muslim', 158, 49.0, 'AB-');

INSERT INTO Admissions (StudentId, AcademicYearId, ClassId, SectionId, RollNo, AdmissionType)
VALUES (
    (SELECT Id FROM Students WHERE PEN = '10100000009'),
    (SELECT Id FROM AcademicYears WHERE IsActive = 1),
    (SELECT Id FROM Classes WHERE ClassName = 'VII'),
    (SELECT Id FROM Sections WHERE SectionName = 'C'),
    1,
